...
export default function CaseStudyListItem({ post }: CaseStudyListItemProps) {
    const excerpt = getExcerptText(post.content.rendered, 220);
            ...
            {featuredImage && (
                <div className="p-5 pb-0">
                    <Link
                        ...
                        className="relative block aspect-video w-full bg-gray-100 overflow-hidden rounded"
                    >
                        <Image
                            src={featuredImage}
                            alt={imageAlt}
