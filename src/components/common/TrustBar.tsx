 ...
 *   - "4-business-hour response" → reduces "will they ghost me?" friction,
 *     and matches the "within 4 business hours" promise on every lead form.
...
export default function TrustBar() {
  const items = [
    ...
    { Icon: Clock, text: "4-business-hour response" },
