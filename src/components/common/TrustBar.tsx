 ...
 *   - "4-hour response time" → reduces "will they ghost me?" friction
 *     (phrased as a response time, not a contractual SLA guarantee).
...
export default function TrustBar() {
  const items = [
    ...
    { Icon: Clock, text: "4-hour response time" },
