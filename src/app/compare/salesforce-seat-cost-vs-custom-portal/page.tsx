        ...
        <section className="section">
          <div className="container">
            ...
            <div style={{ marginTop: "32px", textAlign: "center", display: "flex", gap: "24px", justifyContent: "center", flexWrap: "wrap" }}>
              ...
              <Link href="/reduce-hubspot-seat-costs" className="link">On HubSpot? The HubSpot seat-cost guide →</Link>
              <Link href="/custom-partner-portal-development" className="link">Partner &amp; dealer seats? See custom partner portal development →</Link>
