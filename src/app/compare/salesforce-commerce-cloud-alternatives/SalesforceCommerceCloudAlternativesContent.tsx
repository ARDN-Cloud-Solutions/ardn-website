      ...
      <div className="container">
        <div className="grid grid-cols-1 lg:grid-cols-[280px_1fr] gap-8 py-8 lg:py-16">
          ...
          >
            ...
            <p className="text-heading-dark text-sm lg:text-base mt-4">
              Related: explore <Link href="/custom-ecommerce-development" className="text-heading-dark underline decoration-[#FB7103] underline-offset-4">custom ecommerce development</Link>, or see how it fits our full <Link href="/custom-software-development" className="text-heading-dark underline decoration-[#FB7103] underline-offset-4">custom software development</Link> practice.
            </p>
          </motion.main>
        </div>
      </div>
