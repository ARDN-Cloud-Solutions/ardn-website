...
export const metadata: Metadata = {
  title:
    "Salesforce Commerce Cloud Alternatives (2026) | Ardn",
  description:
    "Compare the best Salesforce Commerce Cloud alternatives in 2026 — Shopify Plus, Adobe Commerce, BigCommerce, WooCommerce, StoreConnect & Ardn Storefronts.",
  keywords: [
    ...
    "@graph": [
      {
        ...
        "@id": url,
        url,
        name: "Salesforce Commerce Cloud Alternatives (2026) | Ardn",
        description:
