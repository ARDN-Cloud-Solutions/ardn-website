...
export const metadata: Metadata = {
  title:
    "Best Salesforce Commerce Cloud Alternatives 2026 | Ardn",
  description:
    "Compare the best Salesforce Commerce Cloud alternatives for 2026 — Ardn Storefronts, Shopify Plus, Adobe Commerce, BigCommerce & more. Pricing, fit & pitfalls.",
  keywords: [
    ...
    "@graph": [
      {
        ...
        "@id": url,
        url,
        name: "Best Salesforce Commerce Cloud Alternatives 2026 | Ardn",
        description:
