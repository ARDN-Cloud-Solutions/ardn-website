...
export const metadata: Metadata = {
  ...
  description:
    "Learn how Ardn Cloud Solutions collects, uses & protects your personal data. Read our Privacy Policy to understand your rights and how we handle your info.",
  alternates: {
