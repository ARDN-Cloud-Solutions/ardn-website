...
export const metadata: Metadata = {
  ...
  description:
    "Learn how Ardn Cloud Solutions collects, uses, and protects your personal data. Read our Privacy Policy to understand your rights over the data you share.",
  alternates: {
