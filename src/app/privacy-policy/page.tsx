...
export const metadata: Metadata = {
  ...
  description:
    "Learn how Ardn Cloud Solutions collects, uses, and protects your personal data — and understand your rights and how we handle the information you share with us.",
  alternates: {
