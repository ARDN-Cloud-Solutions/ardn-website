          ...
          <div className="container">
            <div className="final-cta">
              ...
              <p style={{ marginTop: "20px" }}>
                ...
                {" · "}
                <Link href="/reduce-crm-licensing-costs" style={{ color: "rgba(255,255,255,0.78)", textDecoration: "underline" }}>Replacing seat-based tools? See how to cut CRM licensing costs →</Link>
              </p>
            </div>
          </div>
        </section>
