...
export const metadata: Metadata = {
  ...
  description:
    "Compare the best Salesforce subscription management tools for 2026 — Fonteva, Chargebee, Stripe Billing, Zuora & Ardn. Pricing, fit, and pitfalls.",
  keywords: [
    ...
    "@graph": [
      {
        ...
        "@id": url,
        url,
        name: "Best Salesforce Subscription Management Tools (2026) | Ardn",
        description:
          "Compare 8 top Salesforce subscription management tools in 2026.",
        inLanguage: "en-US",
