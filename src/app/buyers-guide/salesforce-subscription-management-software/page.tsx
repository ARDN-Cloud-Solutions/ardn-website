...
export const metadata: Metadata = {
  title:
    "8 Best Salesforce Subscription Management Tools 2026 | Ardn",
  description:
    "Compare the 8 best Salesforce subscription management tools for 2026 — Ardn Storefronts, Fonteva, StoreConnect, Chargebee, Stripe Billing, Recurly & Zuora.",
  keywords: [
    ...
    "@graph": [
      {
        ...
        "@id": url,
        url,
        name: "8 Best Salesforce Subscription Management Tools 2026 | Ardn",
        description:
          "Compare 8 top Salesforce subscription management tools in 2026.",
        inLanguage: "en-US",
