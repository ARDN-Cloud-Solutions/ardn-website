...
export const metadata: Metadata = {
  title: "AI App Development for Business: Buyer's Guide | Ardn",
  description:
    "How much does an AI app cost? Build vs buy vs outsource? The complete buyer's guide to AI app development for business — pricing, timelines, vendors & ROI.",
  keywords: [
    "AI app development",
    "AI app cost",
