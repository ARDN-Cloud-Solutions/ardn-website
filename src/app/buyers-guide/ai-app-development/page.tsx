...
export const metadata: Metadata = {
  ...
  description:
    "How much does an AI app cost? Build vs. buy vs. outsource, and why most AI projects fail — the complete 2026 buyer's guide to AI app development for business.",
  keywords: [
    "AI app development",
    "AI app cost",
