...
export const metadata: Metadata = {
  ...
  description:
    "How much does an AI app cost? Build vs buy? The complete 2026 buyer's guide to AI app development for business — pricing, timelines, vendor selection and ROI.",
  keywords: [
    "AI app development",
    "AI app cost",
