...
export const metadata: Metadata = {
  title: "AI App Development: 2026 Buyer's Guide | Ardn",
  description:
    "How much does an AI app cost? Build vs. buy vs. outsource? The complete 2026 buyer's guide to AI app development for business — pricing, timelines & ROI.",
  keywords: [
    "AI app development",
    "AI app cost",
