...
export const metadata: Metadata = {
  title:
    "Salesforce E-commerce Solutions (2026) | Ardn",
  description:
    "Compare the best Salesforce-native ecommerce solutions for B2B & B2C in 2026 — Ardn, Commerce Studio, StoreConnect, Shopify Plus & more. Features, fit, pricing.",
  keywords: [
