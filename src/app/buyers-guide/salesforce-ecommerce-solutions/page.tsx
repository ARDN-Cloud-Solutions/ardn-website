...
export const metadata: Metadata = {
  title:
    "Best Salesforce Ecommerce Solutions (2026 Guide) | Ardn",
  description:
    "Compare the best Salesforce-native ecommerce platforms for B2B & B2C in 2026 — features, fit, pitfalls, and pricing to guide your choice.",
  keywords: [
    ...
    "@graph": [
      {
        ...
        "@id": url,
        url,
        name: "Best Salesforce Ecommerce Solutions (2026 Guide) | Ardn",
        description:
