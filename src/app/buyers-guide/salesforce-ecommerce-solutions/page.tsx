...
export const metadata: Metadata = {
  title:
    "Best Salesforce Ecommerce Solutions (2026) | Ardn",
  description:
    "Compare the best Salesforce-native ecommerce solutions for B2B and B2C in 2026 — Storefronts, Commerce Studio, StoreConnect, Shopify Plus & more.",
  keywords: [
    ...
    "@graph": [
      {
        ...
        "@id": url,
        url,
        name: "Best Salesforce Ecommerce Solutions (2026) | Ardn",
        description:
