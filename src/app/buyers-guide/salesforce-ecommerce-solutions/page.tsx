...
export const metadata: Metadata = {
  title:
    "Best Salesforce E-commerce Solutions (2026 Guide) | Ardn",
  description:
    "Compare the best Salesforce-native ecommerce solutions for B2B & B2C in 2026 — Ardn Storefronts, StoreConnect, Shopify Plus & Adobe Commerce. Fit & pricing.",
  keywords: [
