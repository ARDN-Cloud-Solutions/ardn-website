...
export const metadata: Metadata = {
  ...
  description:
    "Compare the best Salesforce workflow automation tools in 2026 — Flow Builder, MuleSoft, Zapier, Workato & more. Reduce manual effort and keep your org clean.",
  keywords: [
    ...
    "@graph": [
      {
        ...
        "@id": url,
        url,
        name: "Salesforce Workflow Automation Tools (2026) | Ardn",
        description:
          "Compare the best Salesforce workflow automation tools in 2026.",
        inLanguage: "en-US",
