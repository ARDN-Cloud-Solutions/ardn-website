...
export const metadata: Metadata = {
  title:
    "Salesforce Workflow Automation Tools: Guide | Ardn",
  description:
    "Compare the best Salesforce workflow automation tools — Flow Builder, Process Builder alternatives, Mulesoft, Zapier & Workato. Simplify processes as you scale.",
  keywords: [
