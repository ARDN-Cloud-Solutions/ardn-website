...
export const metadata: Metadata = {
  title: "Best Salesforce Workflow Automation Tools 2026 | Ardn",
  description:
    "Compare the best Salesforce workflow automation tools in 2026 — Flow Builder, Process Builder alternatives, Mulesoft, Zapier & Workato. Keep your org clean.",
  keywords: [
