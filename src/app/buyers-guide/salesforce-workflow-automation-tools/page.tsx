...
export const metadata: Metadata = {
  ...
  description:
    "Compare the best Salesforce workflow automation tools for 2026 — Flow Builder, MuleSoft, Zapier, Workato & more. Cut manual effort and scale a clean org.",
  keywords: [
    ...
    "@graph": [
      {
        ...
        "@id": url,
        url,
        name: "Best Salesforce Workflow Automation Tools 2026 | Ardn",
        description:
          "Compare the best Salesforce workflow automation tools in 2026.",
        inLanguage: "en-US",
