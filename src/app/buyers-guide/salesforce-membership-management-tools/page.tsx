...
export const metadata: Metadata = {
  ...
  description:
    "Compare the best Salesforce membership management tools for 2026 — Nimble AMS, Fonteva, AC MemberSmart, SubscriptionFlow & Ardn. Criteria, pitfalls & fit.",
  keywords: [
    ...
    "@graph": [
      {
        ...
        "@id": url,
        url,
        name: "Top Salesforce Membership Management Tools 2026 | Ardn",
        description:
