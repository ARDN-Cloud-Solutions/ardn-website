...
export const metadata: Metadata = {
  title:
    "Salesforce Event Ticketing Platforms (2026) | Ardn",
  description:
    "Compare the top 7 Salesforce event ticketing platforms for 2026 — Ardn Storefronts, Blackthorn.io, Fonteva Events, AC Events, EVA, Ticketbud & Eventbrite.",
  keywords: [
    ...
    "@graph": [
      {
        ...
        "@id": url,
        url,
        name: "Salesforce Event Ticketing Platforms (2026) | Ardn",
        description:
          "Compare top Salesforce event ticketing platforms in 2026.",
        inLanguage: "en-US",
