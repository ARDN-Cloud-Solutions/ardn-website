...
export const metadata: Metadata = {
  ...
  description:
    "Compare the top Salesforce event ticketing platforms for 2026 — Ardn Storefronts, Blackthorn, Fonteva Events & Eventbrite. Events, registration & payments.",
  keywords: [
    ...
    "@graph": [
      {
        ...
        "@id": url,
        url,
        name: "Best Salesforce Event Ticketing Platforms (2026) | Ardn",
        description:
          "Compare top Salesforce event ticketing platforms in 2026.",
        inLanguage: "en-US",
