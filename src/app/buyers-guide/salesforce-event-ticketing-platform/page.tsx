...
export const metadata: Metadata = {
  title: "Salesforce Event Ticketing Platforms Compared (2026) | Ardn",
  description:
    "Compare the top 7 Salesforce event ticketing platforms in 2026 — Ardn Storefronts, Blackthorn, Fonteva Events, EVA, Ticketbud & Eventbrite.",
  keywords: [
