...
export const metadata: Metadata = {
  ...
  description:
    "Compare the top Salesforce event ticketing platforms for 2026 — Ardn Storefronts, Blackthorn, Fonteva Events, EVA, Ticketbud & Eventbrite. Native to Salesforce.",
  keywords: [
