...
export const metadata: Metadata = {
  ...
  description:
    "Compare the top Salesforce Commerce AppExchange solutions in 2026 — Ardn Storefronts, StoreConnect, Commerce Studio by 1440, EPOSLY & more for B2B and B2C.",
  keywords: [
    ...
    "@graph": [
      {
        ...
        "@id": url,
        url,
        name: "Salesforce Commerce AppExchange Solutions (2026) | Ardn",
        description:
