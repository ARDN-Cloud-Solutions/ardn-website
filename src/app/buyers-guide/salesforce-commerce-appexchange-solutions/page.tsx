...
export const metadata: Metadata = {
  ...
  description:
    "Compare the top Salesforce-native Commerce AppExchange apps for 2026 — Ardn Storefronts, StoreConnect, Commerce Studio by 1440, EPOSLY & more, for B2B and B2C.",
  keywords: [
