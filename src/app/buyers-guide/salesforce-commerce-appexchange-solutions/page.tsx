...
export const metadata: Metadata = {
  title:
    "Salesforce Commerce AppExchange Solutions: Guide | Ardn",
  description:
    "Compare the top Salesforce Commerce AppExchange solutions for 2026 — Ardn Storefronts, StoreConnect, Commerce Studio by 1440, EPOSLY & more. B2B & B2C.",
  keywords: [
