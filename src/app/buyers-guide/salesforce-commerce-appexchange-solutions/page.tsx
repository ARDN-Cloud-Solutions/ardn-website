...
export const metadata: Metadata = {
  ...
  description:
    "Compare the top Salesforce Commerce AppExchange solutions in 2026 — Ardn Storefronts, StoreConnect, Commerce Studio & more. Find the right B2B/B2C commerce app.",
  keywords: [
