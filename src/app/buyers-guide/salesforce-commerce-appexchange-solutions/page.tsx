...
export const metadata: Metadata = {
  title: "Salesforce Commerce AppExchange Solutions (2026) | Ardn",
  description:
    "Compare the top Salesforce Commerce AppExchange solutions for 2026 — Ardn Storefronts, StoreConnect, Commerce Studio by 1440 & more B2B/B2C apps.",
  keywords: [
