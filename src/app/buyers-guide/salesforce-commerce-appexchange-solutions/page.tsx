...
export const metadata: Metadata = {
  ...
  description:
    "Compare the top Salesforce Commerce AppExchange solutions for 2026 — Ardn Storefronts, StoreConnect, Commerce Studio by 1440, EPOSLY & more. Find the right fit.",
  keywords: [
