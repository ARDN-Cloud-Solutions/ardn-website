...
export const metadata: Metadata = {
  ...
  description:
    "Compare the top Salesforce Commerce AppExchange solutions in 2026 — Ardn Storefronts, StoreConnect, Commerce Studio by 1440, EPOSLY and more, for B2B and B2C.",
  keywords: [
