...
export const metadata: Metadata = {
  title:
    "Best Salesforce Commerce AppExchange Apps (2026) | Ardn",
  description:
    "Compare the top Salesforce Commerce AppExchange solutions for 2026 — Storefronts, StoreConnect, Commerce Studio by 1440, EPOSLY & more — for B2B and B2C.",
  keywords: [
    ...
    "@graph": [
      {
        ...
        "@id": url,
        url,
        name: "Best Salesforce Commerce AppExchange Apps (2026) | Ardn",
        description:
