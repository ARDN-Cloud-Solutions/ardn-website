...
export const metadata: Metadata = {
  title: "Careers — AI & Salesforce Roles in Orlando | Ardn",
  description:
    "Join Ardn Cloud Solutions in Orlando, FL. Open AI engineering, Salesforce, and custom development roles — senior-led teams and ownership from day one.",
  alternates: {
