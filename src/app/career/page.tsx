...
export const metadata: Metadata = {
  title:
    "AI & Salesforce Careers in Orlando | Ardn Cloud Solutions",
  description:
    "Join Ardn Cloud Solutions in Orlando. Open AI engineering, Salesforce, and custom development roles — senior-led teams and direct ownership from day one.",
  alternates: {
