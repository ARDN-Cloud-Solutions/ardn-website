...
export const metadata: Metadata = {
  title:
    "Careers at Ardn Cloud Solutions — AI & Salesforce Roles",
  description:
    "Join Ardn Cloud Solutions in Orlando, FL. Open AI engineering, Salesforce & custom development roles. Senior-led teams and direct ownership from day one.",
  alternates: {
