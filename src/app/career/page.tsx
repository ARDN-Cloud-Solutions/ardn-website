...
export const metadata: Metadata = {
  title:
    "Careers — AI & Salesforce Roles in Orlando | Ardn",
  description:
    "Join Ardn in Orlando, FL. Open AI engineering, Salesforce & custom dev roles. Remote-friendly, senior-led teams, ownership from day one.",
  alternates: {
