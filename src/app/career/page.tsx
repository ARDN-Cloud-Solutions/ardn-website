...
export const metadata: Metadata = {
  title:
    "Careers at Ardn — AI & Salesforce Jobs in Orlando",
  description:
    "Join Ardn Cloud Solutions in Orlando, FL. Open AI, Salesforce & custom dev roles — hybrid, remote-friendly, senior-led teams with ownership from day one.",
  alternates: {
