...
export const metadata: Metadata = {
  title:
    "Careers — Orlando AI & Salesforce Roles | Ardn",
  description:
    "Join Ardn Cloud Solutions in Orlando, FL. Open AI engineering, Salesforce & custom development roles — remote-friendly, senior-led, ownership from day one.",
  alternates: {
