...
export const metadata: Metadata = {
  ...
  description:
    "Join Ardn Cloud Solutions in Orlando, FL. Open AI engineering, Salesforce, and custom development roles — senior-led teams and direct ownership from day one.",
  alternates: {
