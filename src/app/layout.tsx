...
export const metadata: Metadata = {
  ...
  title:
    "Custom Software in Weeks & Salesforce Services | Ardn",
  description:
    "Orlando team building custom software & portals in weeks, not months with the AI Forge Framework — plus Salesforce consulting & managed services.",
  keywords: [
  ...
  openGraph: {
    title:
      "Ardn Cloud Solutions — Custom Software in Weeks & Salesforce Services",
    description:
