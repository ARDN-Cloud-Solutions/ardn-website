...
export const metadata: Metadata = {
  ...
  description:
    "Custom AI application development by a Florida-based team. AI Forge ships production-ready AI apps in 2–6 weeks — built and run for you. Free strategy call.",
  keywords: [
