...
export const metadata: Metadata = {
  title: "AI App Development in Florida — Built in Weeks | Ardn",
  description:
    "Custom AI app development by a Florida team. AI Forge ships production-ready AI apps in 2–6 weeks, built and run for one flat monthly fee. Free strategy call.",
  keywords: [
