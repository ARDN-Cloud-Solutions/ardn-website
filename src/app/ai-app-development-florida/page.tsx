...
export const metadata: Metadata = {
  ...
  description:
    "Custom AI app development by a Florida-based team. Our AI Forge Framework ships production-ready AI apps in 2–6 weeks under one monthly fee. Free 30-min call.",
  keywords: [
