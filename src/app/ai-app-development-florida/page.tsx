...
export const metadata: Metadata = {
  ...
  description:
    "Custom AI app development by a Florida team. The AI Forge Framework ships production-ready AI apps in 2–6 weeks, one flat monthly fee. Free strategy call.",
  keywords: [
