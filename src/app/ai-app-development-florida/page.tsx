...
export const metadata: Metadata = {
  title:
    "AI App Development Florida | Custom AI in Weeks | Ardn",
  description:
    "Custom AI app development by a Florida team. The AI Forge Framework ships production-ready AI apps in 2–6 weeks, built and run under one flat fee. Free call.",
  keywords: [
