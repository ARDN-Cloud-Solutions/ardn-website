...
export const metadata: Metadata = {
  title:
    "AI App Development in Florida — Built in Weeks | Ardn",
  description:
    "Custom AI app development by a Florida team. The AI Forge Framework ships production-ready AI apps in 2–6 weeks under one flat monthly fee. Free 30-min call.",
  keywords: [
