...
export const metadata: Metadata = {
  ...
  description:
    "Custom AI application development by a Florida-based team. Our AI Forge Framework ships production-ready AI apps in 2–6 weeks under one monthly fee. Free call.",
  keywords: [
