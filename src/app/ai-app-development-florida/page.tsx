...
export const metadata: Metadata = {
  ...
  description:
    "Custom AI apps by a Florida team. The AI Forge Framework ships production-ready AI in 2–6 weeks — built, deployed & run for one monthly fee. Free strategy call.",
  keywords: [
