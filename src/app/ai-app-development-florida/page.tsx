...
export const metadata: Metadata = {
  ...
  description:
    "Florida-based custom AI app development. Our AI Forge Framework ships production-ready AI apps in 2–6 weeks under one flat monthly fee. Free strategy call.",
  keywords: [
