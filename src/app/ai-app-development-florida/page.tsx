...
export const metadata: Metadata = {
  ...
  description:
    "Custom AI app development by a Florida team. The AI Forge Framework ships production-ready AI apps in 2–6 weeks, built and run under one flat monthly fee.",
  keywords: [
