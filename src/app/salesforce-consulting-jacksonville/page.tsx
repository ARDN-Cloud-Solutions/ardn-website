...
export const metadata: Metadata = {
  title: "Salesforce Consulting in Jacksonville, FL | Ardn",
  description:
    "Salesforce consulting, implementation, license audits & managed services for Jacksonville businesses. 30+ years of expertise. Book a free 30-min call.",
  keywords: [
