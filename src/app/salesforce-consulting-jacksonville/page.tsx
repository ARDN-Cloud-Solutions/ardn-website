...
export const metadata: Metadata = {
  title:
    "Jacksonville Salesforce Consulting & Managed Services | Ardn",
  description:
    "Salesforce consulting, implementation, license audits & managed services for Jacksonville businesses. Florida team, 30+ years' expertise. Free 30-min call.",
  keywords: [
