...
export const metadata: Metadata = {
  ...
  description:
    "Salesforce consulting, implementation, license audits & managed services for the Jacksonville area. Florida team with 30+ years of expertise. Free 30-min call.",
  keywords: [
