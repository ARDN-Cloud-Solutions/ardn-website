...
export const metadata: Metadata = {
  ...
  description:
    "Salesforce consulting, implementation, license audits & managed services for Jacksonville-area businesses. 30+ years of Salesforce expertise. Free call.",
  keywords: [
  ...
  openGraph: {
    title:
      "Salesforce Consulting & Managed Services in Jacksonville, FL | Ardn",
    description:
