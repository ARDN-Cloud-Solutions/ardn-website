...
export const metadata: Metadata = {
  title:
    "Jacksonville Salesforce Consulting & Managed Svcs | Ardn",
  description:
    "Salesforce consulting, implementation, license audits & managed services for Jacksonville-area businesses. Book a free 30-min strategy call.",
  keywords: [
