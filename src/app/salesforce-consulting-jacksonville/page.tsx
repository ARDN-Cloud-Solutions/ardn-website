...
export const metadata: Metadata = {
  ...
  description:
    "Salesforce consulting, implementation, license audits & managed services in Jacksonville, FL. 30+ years' Salesforce expertise. Book a free call.",
  keywords: [
        ...
        <section className="section is-canvas">
          <div className="container">
            ...
            <p className="body mt-4">Salesforce consulting across Florida:{" "}
              ...
              <Link href="/salesforce-consulting-tampa" className="link">Tampa</Link>.
            </p>
          </div>
        </section>
