...
export const metadata: Metadata = {
  title:
    "Salesforce Consulting & Services, Jacksonville FL | Ardn",
  description:
    "Salesforce consulting, implementation, license audits & managed services for Jacksonville businesses. 30+ years' expertise. Free 30-min call.",
  keywords: [
