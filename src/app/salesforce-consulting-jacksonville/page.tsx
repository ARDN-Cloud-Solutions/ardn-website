...
export const metadata: Metadata = {
  ...
  description:
    "Salesforce consulting, implementation, license audits & managed services for Jacksonville-area businesses. 30+ years of Salesforce expertise. Book a free call.",
  keywords: [
