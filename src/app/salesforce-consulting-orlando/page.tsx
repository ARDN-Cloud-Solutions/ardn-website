...
export const metadata: Metadata = {
  ...
  description:
    "Salesforce consulting, implementation, license audits & managed services from a Florida team with 30+ years of Salesforce expertise. Book a free 30-min call.",
  keywords: [
