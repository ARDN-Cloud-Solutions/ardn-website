...
export const metadata: Metadata = {
  ...
  description:
    "Orlando Salesforce consulting, implementation, license audits, and managed services from a Florida-based team with 30+ years of Salesforce expertise. Free call.",
  keywords: [
