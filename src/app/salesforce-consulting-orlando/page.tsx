...
export const metadata: Metadata = {
  ...
  description:
    "Orlando Salesforce consulting, implementation, license audits & managed services from a Florida team with 30+ years of Salesforce expertise. Free 30-min call.",
  keywords: [
