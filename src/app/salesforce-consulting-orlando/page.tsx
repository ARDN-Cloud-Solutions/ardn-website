...
export const metadata: Metadata = {
  ...
  description:
    "Salesforce consulting, implementation, license audits, and managed services from a Florida-based team with 30+ years of Salesforce expertise. Book a free 30-minute call with an Orlando senior consultant — reply within 4 business hours.",
  keywords: [
