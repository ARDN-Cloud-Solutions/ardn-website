...
export const metadata: Metadata = {
  title:
    "Salesforce Consulting & Managed Services, Orlando FL | Ardn",
  description:
    "Salesforce consulting, implementation, license audits & managed services in Orlando, FL from a team with 30+ years' Salesforce expertise. Book a free call.",
  keywords: [
        ...
        <section className="section is-canvas">
          <div className="container">
            ...
            <p className="body mt-4">Salesforce consulting across Florida:{" "}
              <Link href="/salesforce-consulting-miami" className="link">Miami</Link>,{" "}
              <Link href="/salesforce-consulting-tampa" className="link">Tampa</Link>, and{" "}
