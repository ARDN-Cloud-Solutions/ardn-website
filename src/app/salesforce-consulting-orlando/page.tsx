...
export const metadata: Metadata = {
  ...
  description:
    "Salesforce consulting, implementation, license audits & managed services in Orlando from a Florida team with 30+ years of expertise. Book a free 30-min call.",
  keywords: [
