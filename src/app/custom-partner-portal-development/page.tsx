  ...
  return (
    <main>
      ...
      <div className="ardn-page">
        ...
        <LeadForm source="Custom Partner Portal Development page" heading="See what your partner logins cost you" showSeatQualifiers submitLabel="Show me my savings" sub="Tell us which CRM you run and roughly how many partners have access. We'll come back with where a portal cuts your per-login costs — and a fixed quote." />
