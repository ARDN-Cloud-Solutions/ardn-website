...
export const metadata: Metadata = {
  title: "Custom Software Development Company — Flat Fee | Ardn",
  description:
    "Custom software development company that builds & runs your software, platforms & portals — replace or connect your tools in weeks, one flat fee. No per-seat.",
  keywords: [
