        ...
        <section className="section">
          <div className="container">
            ...
            <div style={{ marginTop: "32px", textAlign: "center", display: "flex", gap: "24px", justifyContent: "center", flexWrap: "wrap" }}>
              ...
              <Link href="/compare/salesforce-seat-cost-vs-custom-portal" className="link">Salesforce per-seat cost vs. custom portal →</Link>
              <Link href="/compare/hubspot-seat-cost-vs-custom-portal" className="link">HubSpot per-seat cost vs. custom portal →</Link>
