      ...
      <section className="section-tight is-canvas">
        <div className="container">
          ...
          <p className="body mt-4" style={{ textAlign: "center" }}>
            Already reclaimed the dormant seats? <Link href="/custom-portal-development" style={{ color: "var(--indigo)", fontWeight: 600 }}>Move light users to a custom portal</Link> to cut the rest of the per-seat bill, or <Link href="/compare/salesforce-seat-cost-vs-custom-portal" style={{ color: "var(--indigo)", fontWeight: 600 }}>see the full seat-cost math</Link>. Have external partners? <Link href="/custom-partner-portal-development" style={{ color: "var(--indigo)", fontWeight: 600 }}>Move them off per-login Partner Community seats</Link>.
          </p>
          <p className="body mt-3" style={{ textAlign: "center" }}>
            New to this? Start with the <Link href="/reduce-crm-licensing-costs" style={{ color: "var(--indigo)", fontWeight: 600 }}>full CRM cost-reduction playbook</Link>, <Link href="/savings-calculator" style={{ color: "var(--indigo)", fontWeight: 600 }}>calculate your per-seat savings</Link>, or see everything we <Link href="/custom-software-development" style={{ color: "var(--indigo)", fontWeight: 600 }}>build to replace seats</Link>.
          </p>
        </div>
      </section>
