      ...
      <section className="section-tight is-canvas">
        <div className="container">
          ...
          <p className="body mt-3" style={{ textAlign: "center" }}>
            <Link href="/reduce-crm-licensing-costs" style={{ color: "var(--indigo)", fontWeight: 600 }}>Read the full guide to cutting CRM licensing costs →</Link>
            {"  ·  "}
            <Link href="/savings-calculator" style={{ color: "var(--indigo)", fontWeight: 600 }}>Calculate your per-seat Salesforce &amp; HubSpot savings →</Link>
          </p>
        </div>
      </section>
