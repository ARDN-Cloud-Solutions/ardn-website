      ...
      <section className="section-tight is-canvas">
        <div className="container">
          ...
          <p className="body mt-4" style={{ textAlign: "center" }}>
            Already reclaimed the dormant seats? <Link href="/custom-portal-development" style={{ color: "var(--indigo)", fontWeight: 600 }}>Move light users to a custom portal</Link>, <Link href="/custom-partner-portal-development" style={{ color: "var(--indigo)", fontWeight: 600 }}>stand up a custom partner portal for resellers</Link> to cut the rest of the per-seat bill, or <Link href="/compare/salesforce-seat-cost-vs-custom-portal" style={{ color: "var(--indigo)", fontWeight: 600 }}>see the full seat-cost math</Link>.
          </p>
