...
export const metadata: Metadata = {
  ...
  description:
    "Salesforce consulting, implementation, license audits & managed services for Tampa Bay. A Florida team with 30+ years of expertise. Free 30-min strategy call.",
  keywords: [
