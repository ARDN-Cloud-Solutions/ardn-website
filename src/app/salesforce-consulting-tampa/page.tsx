...
export const metadata: Metadata = {
  title: "Tampa Salesforce Consulting & Managed Services | Ardn",
  description:
    "Salesforce consulting, implementation, license audits & managed services for Tampa Bay businesses — 30+ years of Salesforce expertise. Free 30-min call.",
  keywords: [
