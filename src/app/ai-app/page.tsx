...
export const metadata: Metadata = {
  ...
  description:
    "We build custom AI applications to your exact specifications, then run them as a monthly service — hosting, maintenance, support & feature work. One flat bill.",
  alternates: {
