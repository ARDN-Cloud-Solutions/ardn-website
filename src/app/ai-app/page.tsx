...
export const metadata: Metadata = {
  title: "Custom AI Apps, Built and Run for You | Ardn",
  description:
    "We build custom AI applications to your exact spec, then run them as a monthly service — hosting, maintenance, AI compute, support & feature work. One bill.",
  alternates: {
