        ...
        <div className="container">
          <div className="final-cta">
            ...
            <p style={{ marginTop: "20px" }}>
              <Link href="/reduce-crm-licensing-costs" style={{ color: "rgba(255,255,255,0.78)", textDecoration: "underline" }}>Cut Salesforce per-seat costs</Link>
              {" · "}
              <Link href="/custom-portal-development" style={{ color: "rgba(255,255,255,0.78)", textDecoration: "underline" }}>Custom customer &amp; partner portals</Link>
            </p>
          </div>
        </div>
      </section>
