...
export const metadata: Metadata = {
    ...
    description:
        "Real-world Salesforce and AI implementation case studies from Ardn Cloud Solutions — enterprise deployments, mid-market launches, and cost-savings outcomes.",
    alternates: {
