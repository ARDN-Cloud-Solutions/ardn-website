...
export const metadata: Metadata = {
    ...
    description:
        "Real-world Salesforce transformation and AI implementation case studies from Ardn Cloud Solutions — mid-market launches and measurable cost-savings outcomes.",
    alternates: {
