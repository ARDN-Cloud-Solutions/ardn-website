...
export const metadata: Metadata = {
    ...
    description:
        "Real-world Salesforce transformation and AI implementation case studies from Ardn — Fortune 500 deployments, mid-market launches, and cost-savings outcomes.",
    alternates: {
