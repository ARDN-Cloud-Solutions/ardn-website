...
export const metadata: Metadata = {
    ...
    description:
        "Real Salesforce transformation and AI implementation case studies from Ardn — Fortune 500 deployments, mid-market launches & measurable cost-savings outcomes.",
    alternates: {
