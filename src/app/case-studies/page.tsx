...
export const metadata: Metadata = {
    ...
    description:
        "Real-world Salesforce transformation and AI implementation case studies from Ardn Cloud Solutions — enterprise and mid-market projects with measurable outcomes.",
    alternates: {
