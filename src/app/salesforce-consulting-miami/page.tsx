...
export const metadata: Metadata = {
  ...
  description:
    "Salesforce consulting, license audits & managed services for Miami & South Florida from a team with 30+ years of Salesforce expertise. Book a free 30-min call.",
  keywords: [
