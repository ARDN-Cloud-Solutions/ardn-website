...
export const metadata: Metadata = {
  ...
  description:
    "Miami & South Florida Salesforce consulting, implementation, license audits, and managed services from a team with 30+ years of Salesforce expertise. Free call.",
  keywords: [
