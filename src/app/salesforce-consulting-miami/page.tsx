...
export const metadata: Metadata = {
  ...
  description:
    "Salesforce consulting, implementation, license audits & managed services for Miami & South Florida — 30+ years of Salesforce expertise. Free 30-min call.",
  keywords: [
  ...
  openGraph: {
    title:
      "Salesforce Consulting & Managed Services in Miami, FL | Ardn",
    description:
